<%-- 
    Document   : appoint
    Created on : 5-Aug-2015, 1:22:56 PM
...
<div id="wrapper">
  ...
  <div id="tabContainer">
    ...
    <li>
        <a href="userconsult.jsp">Consult help desk</a>
    ...
    <li><a href="logout.jsp">Logout</a></li>
           ...
           <br><form name="f1" method="post" action="book1.jsp" action="book.jsp">
            <table width="60%" align="center">
                 <tr><td align="center">school Details:</td></tr>
              <tr>
                         <td><%out.println("You are booking an appointment with . "+(did));%></td>
                    ...
                    <td>
                     ...
                     <tr>
                       ...
                       <tr><td align="center">student Details:</td></tr>
                    <tr> <td> student Id </td>
