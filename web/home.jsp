<%-- 
    Document   : home
    Created on : 25-Jul-2015, 6:01:01 PM
    Author     : c0617418
--%>
		...
		<div class="page">
			...
			<div class="sidebar">
				<ul>
					...
					<li>
						<a href="info.jsp">Achievements</a>
					</li>
                                        <li>
...
<img src="images/doctors.jpg" alt="">
					...
					<div>
						<div>
							<div>
                                                            <h4>Panel of Teacher</h4>
								
								<p>
                                                                    At School's Servicesh , you get to choose not just a teacher, The teacher for your particular needs. Have you consulted us yet? <center><img src="images/programs.jpg" alt=""></center>
								</p>
                                                                 <span><a href="teacher.jsp">Read More</a></span>
							</div>
							<div>
			...
			<div class="footer">
				...
				<p>
					&#169; GaytriShakti Peeth 2015. All rights reserved
				</p>
			</div>
		</div>
	</div>
